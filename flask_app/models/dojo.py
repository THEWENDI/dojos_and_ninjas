...
# from flask_app.controllers.dojos_controller import dojos
from .ninja import Ninja  
# .ninja because ninjia is in the same floder with this file
...
class Dojo:
    ...
    def __init__(self, data):
        ...
        self.ninjas = [] 
        # this is for def get_one_with_ninjas(cls,data)
